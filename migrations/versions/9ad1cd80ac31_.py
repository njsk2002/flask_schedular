...
Revision ID: 9ad1cd80ac31
Revises: fb07886d9bbb
Create Date: 2024-12-26 15:52:44.158866
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user_authorization.id'], name='fk_calendar_schedule_user_id_user_authorization'),
